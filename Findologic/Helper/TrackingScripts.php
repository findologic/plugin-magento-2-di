...
class TrackingScripts extends AbstractHelper
{
    ...
    private function getConfData()
    {
        ...
        /**
         * The hashed shopkey is needed to generate the correct asset path to our CDN.
         * The shopkey generated by Findologic is only used as an identifier to determine which search core is requested.
         * There is no personal data, passwords or other sensitive data involved which means this isn't a security risk.
         */
        // phpcs:disable
